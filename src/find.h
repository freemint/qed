...
extern bool 	s_grkl, s_quant, s_wort, s_vorw, s_global, s_round,
					ff_rekursiv;
extern short		r_modus, rp_box_x, rp_box_y;
...
extern short		start_find		(TEXTP t_ptr, bool quiet);
extern short		start_replace	(TEXTP t_ptr);
extern short		do_next			(TEXTP t_ptr);
extern void		find_selection	(TEXTP t_ptr);

extern bool		filematch		(char *filename, char *m, short fs_typ);
/*
...
extern short		replace_dial	(void);
